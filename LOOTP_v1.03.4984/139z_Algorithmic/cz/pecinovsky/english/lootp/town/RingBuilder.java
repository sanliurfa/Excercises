...
public class RingBuilder
{
    ...
    /** Multishape containing all the ring fields. */
    ...
    public RingBuilder startTo(Direction8 direction)
    {
        ...
        lastField  = new RoadField(startPosition, direction, color, multishape);
    ...
    {
        lastField = new RoadField(lastField, direction, multishape);
    ...
    {
        lastField = new RoadField(lastField, direction, startField, multishape);
