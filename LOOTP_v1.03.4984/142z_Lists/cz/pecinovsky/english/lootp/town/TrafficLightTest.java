...
public class TrafficLightTest
{
    ...
    public void setUp()
    {
        ...
        System.out.println("\n====== Instance v přípravku pro " + this +
                           ...
                           "\n| trafficLightXYB:  " + trafficLightXYC +
                           "\n| trafficLightXYM : " + trafficLightXYM +
                           "\n| trafficLightXYMB: " + trafficLightXYMC +
                           "\n======");
    ...
    /***************************************************************************
     * Tries out the mobility of turning arrow when going around the rings.
     */
    @Test
    ...
    /***************************************************************************
     * Tests the abilities of comparator in class {@link TestUtility}
     * when sorting traffic lights.
     */
    @Test
    public void testSortList()
    {
        ...
        seznam.add(trafficLightXYC);
        seznam.add(trafficLightXYM);
        seznam.add(trafficLightXYMC);
        seznam.add(trafficLight0);
