...
public class Tests
{
    ...
    /***************************************************************************
     * Several times measures the time among two clock ticks
     * and the number of loop body executions performed in that time.
     */
    @Test
    public  void testClockGranularity()
    {
        int  attempts = 10;
        int  attempt  = 0;
        long time1    =  System.currentTimeMillis();
        long time2    = time1;
        System.out.println("===== Start of granularity test =====");
        while( ++attempt <= attempts )
        {
            ...
            System.out.println("Attempt "  + attempt  +
                               ":  Time=" + (time2-time1) +
                               " ms with " + execution + ". executions");
            time1 = time2;
        }
        System.out.println("===== End of granularity test =====");
    }
