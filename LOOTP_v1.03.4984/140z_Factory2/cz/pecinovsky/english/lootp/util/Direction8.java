...
//
//    /***************************************************************************
//     * Přemístí objekty v zadané čtvercové oblasti tak, aby to vypadalo,
//     * že se celá oblast otočila ze směru zadaného v parametru,
//     * do daného směru.
//     *
//     * @param ref    Referenční oblast, která je zdánlivě otáčena
//     *               a vůči níž jsou udávány výchozí souřadnice.
//     *               V této otočené oblasti má být oblast umístěna po otočení.
//     *               Přitom se předpokládá, že souřadnice referenční oblasti
//     *               se otočením nezmění.
//     *               V tomto ohledu je ideální referenční oblast čtvercová.
//     * @param fromDirection Směr, do nějž je objekt natočen nyní
//     * @param shapes Objekty nacházející se v zadané referenční oblasti,
//     *               vůči níž jejich pozice přepočítáváme
//     */
//    public void turnInArea(Area ref, Direction8 fromDirection,
//                                     IChangeable... shapes)
//    {
//        verifyAllowed();
//        if (this == NOWHERE) {
...
//        }
//        int distance = fromDirection.ordinalDistanceTo(this);
//        for (IChangeable shape : shapes) {
//            Position orgPos  = shape.getPosition();
//            Size     orgSize = shape.getSize();
//
//            Area relArea = new Area(orgPos.x - ref.x, orgPos.y - ref.y,
//                                    orgSize.width,    orgSize.height);
//            Area absArea = turnInArea(ref, relArea, fromDirection);
//            if (shape instanceof IDirectable) {
//                IDirectable directable = (IDirectable)shape;
//                Direction8 newDirection = directable.getDirection()
//                                                    .turnBy(distance);
//                directable.setDirection(newDirection);
//            }
//            shape.setPosition(absArea.x, absArea.y);
//            shape.setSize(absArea.width, absArea.height);
//        }
//    }
//
    ...
    public void turnTo4(ITurnable4 turnable)
    {
        ...
        if (! (this.isMain()  &&  direction.isMain())) {
            throw new IllegalStateException(
                  "Metodu lze použít pouze pro čtyři hlavní světové strany");
        }
