...
public class CarTest
{
    ...
    /***************************************************************************
     * Exchanges positions of entered cars and checks
     * if the position was really exchanged.
     *
     * @param c1 First car
     * @param c2 Second car
     */
    private void auxSwapPositionsWithCheck(Car c1, Car c2)
    {
        Position p1 = c1.getPosition();
        Position p2 = c2.getPosition();

        System.out.println("Výchozí: " + p1 + " <--> " + p2);
        auxSmoothlySwapPositions(c1, c2);
        System.out.println("Cílová:  " + c1.getPosition() +
                              " <--> " + c2.getPosition() + "\n");

        assertEquals(p1, c2.getPosition());
        assertEquals(p2, c1.getPosition());
    }
    ...
    {
        auxSwapPositionsWithCheck(car0,   carXYB);
        auxSwapPositionsWithCheck(carXYB, carXYM);
        auxSwapPositionsWithCheck(carXYM, carXYMB);
    }
}
