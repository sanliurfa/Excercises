...
public class TrafficLight implements IModular
    ...
    public TrafficLight(int x, int y, int module, NamedColor boxColor)
    {
        ...
        redLight   = new Light  (x, y,          module, NamedColor.RED,    NamedColor.NO);
        amberLight = new Light  (x, y+  module, module, NamedColor.YELLOW, NamedColor.NO);
        greenLight = new Light  (x, y+2*module, module, NamedColor.GREEN,  NamedColor.NO);
    }
