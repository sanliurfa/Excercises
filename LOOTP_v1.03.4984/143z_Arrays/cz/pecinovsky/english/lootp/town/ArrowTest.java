...
public class ArrowTest
{
    ...
    /***************************************************************************
     * Tests the abilities of turning arrow of going around the rings.
     */
    @Test
    public void testMobility()
    {
        TestUtility.runRing(new Arrow());
    }
    ...
    {
//        List<IModular> seznam = TestUtility.newListIModular(
//                        arrow0, arrowXY, arrowXYB, arrowXYM, arrowXYMB, arrow0);
//        TestUtility.seřaďSeznam(seznam);
        TestUtility.seřaďSeznam(TestUtility.newListIModular(
                    arrow0, arrowXY, arrowXYB, arrowXYM, arrowXYMB, arrow0));
    }
