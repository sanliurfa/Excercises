...
//        System.out.println("Colors:\n" + sb);
    ...
    /***************************************************************************
     * Returns the named color with the given index.
     *
     * @param index Index of the required color in the list of named colors
     * @return      Named color with the given index
     */
     ...
     * This method is used in the class
     * {@link cz.pecinovsky.english.lootp.manager.CanvasManager}.
     *
