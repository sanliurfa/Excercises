...
public class LightTest
{
    ...
    public void setUp()
    {
        ...
        System.out.println("\n====== Instances in the test fixture for " + this +
                           "\n| CM: "        + CM +
                           "\n| light0:     " + light0      +
                           "\n| lightXY:    " + lightXY     +
                           "\n| lightXYC:   " + lightXYC    +
     ...
     * @param l2 Second light
     */
    private void auxSwapPositionsWithCheck(Light l1, Light l2)
    {
        Position p1 = l1.getPosition();
        Position p2 = l2.getPosition();

        System.out.println("Výchozí: " + p1 + " <--> " + p2);
        auxSwapPositions(l1, l2);
        System.out.println("Cílová:  " + l1.getPosition() +
                              " <--> " + l2.getPosition() + "\n");
    ...
    {
        auxSwapPositionsWithCheck(light0,   lightXYDC);
        auxSwapPositionsWithCheck(lightXYC, lightXYD);
        auxSwapPositionsWithCheck(lightXYD, light0);
    }
}
